...
const featureData = [
  {
    titleKey: "features.instantStore",
    descKey: "features.instantStoreDesc",
    icon: (
  ...
  {
    titleKey: "features.whatsapp",
    descKey: "features.whatsappDesc",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    titleKey: "features.notifications",
    descKey: "features.notificationsDesc",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    titleKey: "features.mobile",
    descKey: "features.mobileDesc",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export default function Features() {
  ...
  return (
    <section id="features" className="bg-warm-50 py-16 sm:py-24">
